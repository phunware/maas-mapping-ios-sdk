...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name:"PWCore", url:"https://github.com/phunware/maas-core-ios-sdk.git", .branch("task/3.12.0-spm")),
        .package(name:"PWLocation", url:"https://github.com/phunware/maas-location-ios-sdk.git", .branch("task/3.12.0-spm"))
    ],
    targets: [
