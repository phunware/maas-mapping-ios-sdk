...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "PWCore", url: "https://github.com/phunware/maas-core-ios-sdk.git", from: "3.13.0"),
        .package(name: "PWLocation", url: "https://github.com/phunware/maas-location-ios-sdk.git", from: "3.14.0")
    ],
    targets: [
