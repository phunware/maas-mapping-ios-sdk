...
#ifndef PWMAPKIT_SWIFT_H
#define PWMAPKIT_SWIFT_H
...
SWIFT_CLASS("_TtC8PWMapKit8PWCampus")
@interface PWCampus : NSObject
@property (nonatomic, readonly) NSInteger identifier;
@property (nonatomic, readonly, copy) NSString * _Nullable name;
@property (nonatomic, readonly, copy) NSArray<PWBuilding *> * _Nullable buildings;
@property (nonatomic, readonly, copy) NSArray<PWFloor *> * _Nullable floors;
@property (nonatomic, readonly, copy) NSArray<PWPointOfInterest *> * _Nullable pois;
@property (nonatomic, readonly, copy) NSArray<PWPointOfInterestType *> * _Nullable pointOfInterestTypes;
@property (nonatomic, readonly, copy) NSDictionary<NSString *, id <PWMapPoint>> * _Nullable routePoints;
@property (nonatomic, readonly, copy) NSDictionary<NSString *, NSDictionary<NSString *, NSNumber *> *> * _Nullable routeSegments;
...
SWIFT_CLASS("_TtC8PWMapKit15PWCampusManager")
@interface PWCampusManager : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
