...
/**
 ...
 Do not create instances of this class directly. Instead, use `createRouteFrom: to: accessibility: excludedPoints: completion:`.
 */
 ...
 *
 *  @deprecated Use `createRouteFrom: to: accessibility: excludedPoints: completion:` instead, since v3.2.0.
 */
