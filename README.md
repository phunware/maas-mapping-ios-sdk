...
- PWLocation 3.1.7.1 or greater (Automatically included when pod install PWMapKit)
- PWCore 3.0.3 or greater (Automatically included when pod install PWMapKit)
- iOS 9.0 or greater
- Xcode 8 or greater
